...
class UserController extends Controller
{
    ...
    public function test()
    {
        ...
        $good->image = 'badge1.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good = new Good;
        $good->name = 'BJMUN 徽章（大）';
        $good->image = 'badge2.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good = new Good;
        $good->name = 'BJMUN 书签';
        $good->image = 'bookmark.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good = new Good;
        $good->name = 'BJMUN 水杯（陶瓷）';
        $good->image = 'cup1.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good = new Good;
        $good->name = 'BJMUN 水杯（变色）';
        $good->image = 'cup2.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good = new Good;
        $good->name = 'BJMUN 帽衫（S）';
        $good->image = 'hoot.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        $good->name = 'BJMUN 帽衫（M）';
        $good->image = 'hoot.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        ...
        $good->remains = 0;
        $good->save();
        $good->name = 'BJMUN 手机壳（iPhone 7）';
        $good->image = 'phone.jpeg';
        $good->price = 0;
        $good->remains = 0;
        $good->save();
        return "gouli";
