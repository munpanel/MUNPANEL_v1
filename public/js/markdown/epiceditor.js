...
(function (window, undefined) {
  ...
  EpicEditor.prototype._setupTextareaSync = function () {
    ...
    _syncTextarea = function () {
      ...
      // This way, we can get the content even if it is not saved to local storage, by adamyi.
      self._textareaElement.value = _getText(self.editor);//self.exportFile(self.settings.file.name, 'text', true) || self.settings.file.defaultContent;
    }
