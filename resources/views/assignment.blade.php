...
@push('scripts')
    ...
    <script src="{{secure_url('/js/assignment.js')}}"></script>
@endpush
@push('css')
            ...
            <table class="table table-striped m-b-none" id="assignment-table">
              ...
              <!-- tbody>
                <tr>
                  ...
                  <td>Feb 1, 2016</td>
                  <td>
                    <a class="active" href="#"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a>
                  </td>
                </tr>
                  <tr><td>2</td>
                  <td><a href="assign_detail.html"><i class="fa fa-search-plus"></i></a></td>
