...
<div class="panel">
  ...
  <div class="panel-body">
    <div class="text-center col-sm-3">
      ...
      <div class="inline">
        <div class="easypiechart easyPieChart" data-size="100" data-line-width="4" data-percent="{{$interviews['arranged'] + $interviews['unarranged'] > 0 ? ($interviews['arranged'] * 100 / ($interviews['arranged'] + $interviews['unarranged'])) : 0}}" data-loop="false">
