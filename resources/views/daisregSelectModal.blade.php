      ...
      <div class="modal-content">
          <div class="modal-body">
            <div class="row">
              ...
              <center>
              <a href="{{ mp_url('/reg2.modal/delegate') }}" data-toggle="ajaxModal" class="btn btn-link"{{!$daisUse ? ' disabled=""' : ''}}>
              ...
              <div class="col-sm-4 b-r">
              <center>
              <a href="{{ mp_url('/reg2.modal/volunteer') }}" data-toggle="ajaxModal" class="btn btn-link"{{!$otUse ? ' disabled=""' : ''}}>
