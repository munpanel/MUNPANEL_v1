        ...
        <section>
          ...
          <nav class="nav-primary hidden-xs">
            <ul class="nav">
              ...
              <li class="{{ isset($active['documents']) ? $active['documents'] : '' }}">
                <a href="{{ secure_url('/documents') }}">
                  <i class="fa fa-file-text"></i>
                  <span>Documents</span>
                </a>
              </li>
              <li class="{{ isset($active['pages']) ? $active['pages'] : '' }}">
              ...
              <li class="{{ isset($active['chair']) ? $active['chair'] : '' }}">
                <a href="{{ secure_url('/chair') }}">
                  <i class="fa fa-tasks"></i>
                  <span>Live Screen</span>
                </a>
              </li>
              <li class="{{ isset($active['fb']) ? $active['fb'] : '' }}">
                <a href="{{ secure_url('/fb') }}">
                  <i class="fa fa-pencil"></i>
                  <span>Feedback</span>
                </a>
              </li>
              <li {{ isset($active['ddltimer']) ? $active['ddltimer'] : '' }}>
