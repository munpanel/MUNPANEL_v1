                <div id="ot_verify" style="display: block;">
                    ...
                    <button name="noVerify" type="button" class="btn btn-danger m-l" onclick="$('#ot_verify').hide(); $('#ot_noverify_confirm').show();">不通过</button>
                ...
                <div id="ot_noverify_confirm" style="display: none;">
                   ...
                   <a class="btn btn-danger m-l" href="{{mp_url('/ot/oNoVerify/'.$reg->id)}}">是</a>
                   <button name="cancel" type="button" class="btn btn-white m-l" onclick="$('#ot_noverify_confirm').hide(); $('#ot_verify').show();">否</button>
