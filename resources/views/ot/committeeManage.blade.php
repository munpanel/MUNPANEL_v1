...
@push('scripts')
    ...
    <script src="{{secure_url('/js/ot.committeeManage.js')}}"></script>
@endpush
@push('css')
            ...
            <header class="header bg-white b-b clearfix">
              <div class="row m-t-sm">
                <div class="col-sm-6 m-b-xs">
                  ...
                  <a href="{{secure_url('/ot/committeeDetails.modal/new')}}" class="btn btn-sm btn-success details-modal"><i class="fa fa-plus"></i> 新建</a>
                </div>
                <div class="col-sm-6 m-b-xs">
