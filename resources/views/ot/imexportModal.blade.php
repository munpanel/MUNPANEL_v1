          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-sm-12 b-r">
                ...
                <form id="uploadForm" enctype="multipart/form-data" action="{{$importURL}}"  method="post"><!-- ToDo: validation -->
                  {{ csrf_field() }}
                  <br>请选择您要导入的表格文件。<br><input type="file" title="Browse" name="file" class="parsley-required" data-required="true"><button type="submit" class="btn btn-success pull-right" data-validate="parsley">导入</button>
                </form>
              </div>
            </div>
          </div>          
