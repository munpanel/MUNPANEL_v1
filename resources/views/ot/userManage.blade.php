...
@push('scripts')
    ...
    <script src="{{cdn_url('/js/ot.userManage.js')}}"></script>
@endpush
@push('css')
...
<section class="vbox">
            <header class="header bg-white b-b clearfix">
              <div class="row m-t-sm">
                <div class="col-sm-6 m-b-xs">
                  ...
                  <a href="{{mp_url('/ot/userDetails.modal/new')}}" class="btn btn-sm btn-success details-modal"><i class="fa fa-plus"></i> 新建</a>
                </div>
                <div class="col-sm-6 m-b-xs">
            ...
            <section class="scrollable wrapper w-f">
              <section class="panel">
                <div class="table-responsive">
                  <table class="table table-striped m-b-none" id="user-table">
                    <thead>
                      <tr>
            ...
            <footer class="footer bg-white b-t">
              <div class="row m-t-sm text-center-xs">
                <div class="col-sm-4">
                  <div class="dataTables_length" id="user-table_length_new"><label>每页 <select name="user-table_length" id="user-length-select"aria-controls="user-table" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> 条记录</label></div>
                </div>
                <div class="col-sm-4 text-center">
                  <small class="text-muted inline m-t-sm m-b-sm" id="user-pageinfo"></small>
                </div>
                <div class="col-sm-4 text-right text-center-xs">                
                  <ul class="pagination pagination-sm m-t-none m-b-none" id="user-pagnination">
                  </ul>
                </div>
              </div>
            </footer>
