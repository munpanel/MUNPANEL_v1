            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="individual">我们坚信我们不仅要服务于每一位代表，也要服务于各校管理层，简化其报名工作。从帮助学校收集报名信息开始，再到帮助学校收钱。选用此种方式，贵校代表可自行登录MUNPANEL系统，线上通过微信支付、支付宝直接支付会费，系统实时自动确认收费并更新代表状态，省去学校社团管理层中间收钱步骤，便捷高效。<br><br><a href="{{mp_url('/school/pay/change/individual')}}" class="btn btn-s-md btn-success btn-rounded pull-right">选用此种方式</a></div>
                    <div class="tab-pane" id="group">您亦可选择传统的整校费用收齐后银行转帐的模式。<br><br>转账信息：<br>户名：朱淇惠<br>账号：6212 2602 0010 3912 990<br>开户行：中国工商银行 – 北京珠市口大栅栏支行<br><br>请成员校负责人将学校所有参会人员会费收齐后统一转账，并在备注处注明 BJMUN 会费字样学校名称，代表人数和住宿志愿者人数。<br><br><a href="{{mp_url('/school/pay/change/group')}}" class="btn btn-s-md btn-success btn-rounded pull-right">选用此种方式</a></div>
                  </div>
                </div>
              </section>
                </div>
